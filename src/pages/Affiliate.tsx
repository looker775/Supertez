      ...
      <section className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
        <div className="space-y-6">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-slate-900">
            {t('affiliate.hero_title', { defaultValue: 'Promote Supertez and earn with every client you refer.' })}
          </h1>
          <p className="text-lg text-slate-600">
            {t('affiliate.hero_subtitle', {
              defaultValue:
                'Share your unique client signup link. Track registrations and performance in your own dashboard.',
            })}
          </p>
        ...
        <div className="app-card p-6 space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-slate-100 bg-white/90 p-4">
              ...
              <p className="text-xs text-slate-500">
                {t('affiliate.panel_item_one_sub', { defaultValue: 'Each blogger gets their own client signup URL.' })}
              </p>
            </div>
            <div className="rounded-2xl border border-slate-100 bg-white/90 p-4">
              ...
              <p className="text-xs text-slate-500">
                {t('affiliate.panel_item_two_sub', { defaultValue: 'See who registered and how many clients joined.' })}
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        {[
          ...
          },
          {
            ...
            body: t('affiliate.step_two_body', { defaultValue: 'Send your client signup link to your audience.' }),
          },
          {
            title: t('affiliate.step_three_title', { defaultValue: 'Track results' }),
            body: t('affiliate.step_three_body', { defaultValue: 'Watch client registrations appear in your CRM.' }),
          },
        ].map((item) => (
