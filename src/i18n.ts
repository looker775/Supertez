      ...
      en: {
        translation: {
          ...
          landing: {
            ...
            affiliate_subtitle: 'Get a unique client signup link and track your referrals in a CRM dashboard.',
          ...
          admin: {
            ...
            affiliates: {
              title: 'Affiliate CRM',
              subtitle: 'Track bloggers and client registrations.',
              total_affiliates: 'Total affiliates',
              total_drivers: 'Clients referred',
      ...
      ru: {
        translation: {
          ...
          landing: {
            ...
            affiliate_subtitle: 'Получите уникальную ссылку регистрации клиентов и CRM-отчёты по заявкам.',
          ...
          affiliate: {
            ...
            hero_title: 'Продвигайте Supertez и получайте вознаграждение за каждого клиента.',
            hero_subtitle: 'Делитесь своей уникальной ссылкой регистрации клиентов. Отслеживайте результаты в своей CRM.',
            cta_join: 'Стать блогером',
            cta_login: 'Вход для блогера',
            cta_dashboard: 'Перейти в CRM блогера',
            panel_title: 'Инструменты продвижения',
            panel_subtitle: 'Каждая регистрация клиента отслеживается по вашей ссылке.',
            panel_item_one: 'Уникальная ссылка',
            panel_item_one_sub: 'У каждого блогера своя ссылка на регистрацию клиента.',
            panel_item_two: 'CRM-панель',
            panel_item_two_sub: 'Смотрите, кто зарегистрировался и сколько клиентов пришло.',
            ...
            step_two_body: 'Отправьте ссылку регистрации клиента своей аудитории.',
            step_three_title: 'Отслеживайте результат',
            step_three_body: 'Новые регистрации клиентов появятся в вашей CRM.',
            dashboard_title: 'CRM блогера',
            dashboard_subtitle: 'Отслеживайте клиентов, пришедших по вашей ссылке.',
            status_active: 'Активен',
            link_title: 'Ваша ссылка регистрации клиента',
            link_subtitle: 'Поделитесь ссылкой для учёта регистраций клиентов.',
            copy_button: 'Копировать',
            copied: 'Скопировано!',
            copy_failed: 'Не удалось скопировать',
            total_drivers: 'Всего клиентов',
            total_hint: 'Счётчик обновляется после регистрации клиента.',
            driver_list: 'Клиенты по вашей ссылке',
            table: {
              name: 'Имя',
              contact: 'Контакт',
              city: 'Город',
          ...
          admin: {
            ...
            affiliates: {
              title: 'CRM блогеров',
              subtitle: 'Отслеживайте блогеров и регистрации клиентов.',
              total_affiliates: 'Всего блогеров',
              total_drivers: 'Клиентов по ссылкам',
